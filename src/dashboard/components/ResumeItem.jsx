...
const ResumeItem = ({resume,refreshData}) => {
  ...
  <div className='p-14  bg-gradient-to-bl from-slate-300 to-slate-50
  h-[280px] 
  ...
  items-center justify-center h-[180px] '>
          {/* <Notebook/> */}
          <img src="/src/assets/3d-cv-resume-icon_165488-4908-removebg-preview.png" width={400} height={400} className="hover:rotate-6 hover:scale-125 transition-all" />
        </div>
  </div>
  </Link>
